...
- Contains additional heavy dependencies specified in `comic_ocr_dev/requirements.txt`: `html2image`, `albumentations`, `opencv-python`, `datasets`, `wandb`, `budou`, `torchinfo`, `scikit-image`, `fontTools`.
